...
interface WebContainerPreviewProps {
  ...
  forceResetup?: boolean; // Optional prop to force re-setup of the WebContainer
}
  ...
  useEffect(() => {
    async function setupContainer() {
      ...
      try {
        ...
        // Step-1 Transform the template data to WebContainer format
        ...
        // Step-2 Mount the files to the WebContainer instance
