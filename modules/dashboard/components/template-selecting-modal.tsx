    ...
    >
      <DialogContent className="sm:max-w-200 max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#8B5CF6] flex items-center gap-2">
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02] ${
                          selectedTemplate === template.id
                            ? "border-violet-500 ring-1 ring-violet-500/30 shadow-[0_12px_32px_rgba(139,92,246,0.25)] bg-violet-50/50 dark:bg-violet-950/20"
                            : "hover:border-violet-500 hover:ring-1 hover:ring-violet-500/20 shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_12px_32px_rgba(139,92,246,0.15)]"
                        }
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#8B5CF6] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 rounded-lg border border-[#8B5CF6]/20 bg-[#8B5CF6]/5 shadow-[0_0_0_1px_rgba(139,92,246,0.25),0_8px_20px_rgba(139,92,246,0.15)]">
                <h3 className="font-medium mb-2 text-[#8B5CF6]">
